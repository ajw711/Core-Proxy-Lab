...
public class NioProxyServer {
    ...
    private static void handleTargetConnection(SelectionKey key, String request) throws IOException {
    ...
    private static void relay(SelectionKey key) throws IOException {
